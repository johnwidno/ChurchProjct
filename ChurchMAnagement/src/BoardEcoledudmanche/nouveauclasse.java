 ...
 * @author qwewrty
 */
public class nouveauclasse extends javax.swing.JDialog {

    /**
     * Creates new form nouveauclasse
     */
    public nouveauclasse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOUVELLE CLASSE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nouveauclasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nouveauclasse dialog = new nouveauclasse(new javax.swing.JFrame(), true);
