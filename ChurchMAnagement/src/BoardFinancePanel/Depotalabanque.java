 ...
 * @author Dorcy
 */
public class Depotalabanque extends javax.swing.JDialog {

    /**
     * Creates new form Depotalabanque
     */
    public Depotalabanque(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selectionner ici", "HTG", "USD" }));
 ...
 dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Depotalabanque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Depotalabanque dialog = new Depotalabanque(new javax.swing.JFrame(), true);
