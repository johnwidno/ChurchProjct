 ...
 * @author qwewrty
 */
public class nouveauSalles extends javax.swing.JDialog {

    /**
     * Creates new form nouveauclasse
     */
    public nouveauSalles(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOUVELLE SALLE");
        ...
        jLabel6.setText("Activité d'usage");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choisir un baptiment ici..", "Batiment10" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nouveauSalles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nouveauSalles dialog = new nouveauSalles(new javax.swing.JFrame(), true);
