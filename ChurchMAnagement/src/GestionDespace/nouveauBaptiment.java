 ...
 * @author qwewrty
 */
public class nouveauBaptiment extends javax.swing.JDialog {

    /**
     * Creates new form nouveauclasse
     */
    public nouveauBaptiment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOUVEAU BATIMENT");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel2.setText("Nom du Baptiment");
        ...
        jLabel6.setText("Date de fondation");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nouveauBaptiment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nouveauBaptiment dialog = new nouveauBaptiment(new javax.swing.JFrame(), true);
